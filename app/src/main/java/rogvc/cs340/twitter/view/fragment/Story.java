...
public class Story extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        PostListAdapter adapter = new PostListAdapter(myView.getDisplayedUser().getStory(), myView);
        ...
        RecyclerView mRecyclerView = view.findViewById(R.id.story_recyclerView);
